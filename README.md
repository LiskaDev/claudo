...
<div align="center">
  <img src="https://github.com/user-attachments/assets/172ab3d1-673c-46ab-8ce3-7e2373e9e22c" width="600" alt="对话仪表" />
</div>
...
**Note:** When an out-of-quota warning appears (e.g. `You're out of extra usage ∙ Your limit resets Sunday at 5:00 PM`), the position of the Context Gauge will shift to avoid overlapping.
...
**注意：**当出现额度超出警告时（例如 `You're out of extra usage ∙ Your limit resets Sunday at 5:00 PM`），对话仪表位置会偏移。
