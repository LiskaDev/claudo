    ...
    <div className={`absolute top-1/2 -translate-y-1/2 ${sideClass} z-50`}>
      <div className="relative w-[18rem] rounded-xl border border-zinc-700/50 bg-[#18181b]/95 backdrop-blur-md p-3 text-zinc-200 shadow-[0_8px_32px_rgba(0,0,0,0.4)]">
        ...
        <div className="mb-2 flex items-center justify-between text-[12px] text-zinc-400">
          ...
          <div className="font-medium text-zinc-200">{displayValue}</div>
        </div>
        ...
        <div className="mt-3 flex justify-end">
          <button
            type="button"
            className="flex items-center gap-2 rounded-lg border border-zinc-600 bg-zinc-800 px-2 py-1 text-[12px] text-zinc-300 hover:bg-zinc-700"
